...
var TitleWidget = function(options) {
    ...
    wrapper.innerHTML = '\
        <div class="ausglobe-title-image"><img src="'+window.NATIONALMAP_URL+'images/Australia.png" width="60" height="46" /></div>\
        <div class="ausglobe-title-image"><img src="'+window.NATIONALMAP_URL+'images/nicta.png" width="60" height="60" /></div>\
        <div class="ausglobe-title-image"><img src="'+window.NATIONALMAP_URL+'images/nationalmap.png" width="99" height="40" /></div>\
